# Benchmarking
echo -e "\n*****\nBENCHMARK (measures performance/speed of your server)\n*****\n"
echo -e "This script measures the speed of your machine in various ways."
echo -e "Storage space speeds, CPU, meory, and network performance.\n"
...
echo -e "***** Write speed (want >400 MB/s)"
...
echo -e "***** CPU benchmark (want >300 MB/s)"
...
echo -e "\nA lengthy benchmark will run next. It could take a few minutes..."
echo -e "Press Enter... "; read shit
